<<<<<<< Updated upstream:app/src/main/java/com/goingbacking/goingbacking/MainActivityPackage/ThirdMainFragmentPackage/ScheduleInputActivity.kt
...
>>>>>>> Stashed changes:app/src/main/java/com/goingbacking/goingbacking/bottomsheet/CalendarBottomSheet.kt
...
=======
            ...
            eventsAdapter.apply {
                events.clear()
                //events.addAll(requireActivity().events[LocalDate.now()].orEmpty())
